...
const { sendMFA, register, login, forgotPassword, verifyOtp, resetPassword, sendMFADoctor, loginDoctor,  registerDoctor, doctorForgotPassword, verifyOtpDoctor, doctorResetPassword } = require('../controllers/authController');
